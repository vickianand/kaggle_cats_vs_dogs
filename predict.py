...
def predict(image_folder="data/testset/", device=torch.device("cpu"), model_path="data/model/ep1_accr50.3.pt"):
    ...
    for i, (x, _) in enumerate(dataloader):
        ...
        answer += ["{},{}\n".format(im_name[0].split('/')[-1].split('.')[0], "Dog" if y[i] else "Cat")
                   for i, im_name in enumerate(dataset.samples[data_count:data_count+x.shape[0]])]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_folder", type=str, default="data/testset/",
                        help="Path to the folder having images to predict on")
    parser.add_argument("--model_path", type=str, default="data/model/ep1_accr50.3.pt",
